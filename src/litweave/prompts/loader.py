"""PromptRegistry: load and validate role prompts from src/litweave/prompts/.
...
3. `schema:` resolves to a real Pydantic class in litweave.schemas
...
SCHEMA_MODULE: dict[str, str] = {
    "PlannerOutput": "litweave.schemas.planner",
    "PlannerSection": "litweave.schemas.planner",
    "ResearcherWideOutput": "litweave.schemas.research",
    "ResearcherDeepOutput": "litweave.schemas.research",
    "CandidatePaper": "litweave.schemas.research",
...
class PromptRegistry:
    """Loads + validates prompts from src/litweave/prompts/."""
